...
golem::add_module(name = "data_loading", with_test = TRUE) # Name of the module
golem::add_module(name = "information", with_test = TRUE) # Name of the module
...
## Vignette ----
usethis::use_vignette("labelcolor")
